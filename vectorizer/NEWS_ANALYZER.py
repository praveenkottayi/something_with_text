...
def load_news_from_csv():
    with open("sub_News_data_test.csv",'r',encoding="utf8") as my_file:
...
def news_classifier(x):    
    from sklearn.externals import joblib      
    vec_loaded = joblib.load('vectorizer.pkl')   
...
class Example(Frame):
    ...
    def getNews(self):
        ...
        getNewsLabel = Label(self, text= "..............................."*32, font=('Helvetica 10'), bg= "sky blue", wraplength=500)
        getNewsLabel.grid(row=1, column=1)
        getNewsLabel = Label(self, text= text, font=('Helvetica 8'), bg= "sky blue", wraplength=500)
        getNewsLabel.grid(row=1, column=1)
